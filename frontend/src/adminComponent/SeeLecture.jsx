...
<div className='mt-3 d-flex flex-column gap-2 align-items-center'>
  {lecture.length > 0 ? (
     ...
     {
     lecture.map((item,i)=>(
<div className='p-3 ' key={i} style={{boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.2)",borderRadius:'9px',width:"100%",maxWidth:"450px"}}>
      <div className='d-flex justify-content-between align-items-center'>
         ...
         <div className='d-flex gap-2'>
          ...
          <BiEditAlt className='edit_Course_iconn' onClick={()=>navigate(`/admin/EditLecture/${id}/${item._id}`)}/>
         </div>
