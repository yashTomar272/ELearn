...
useEffect(() => {
 ...
 const capitalizeFirstLetter = (string) => {
  ...
  <BiSolidLock className='edit_Course_icon' />
   ...
   <span style={{color:"black",fontSize:"16px",fontWeight:"600"}}><span style={{color:"black",fontSize:"14px",fontWeight:"500"}}>Teacher name:</span>{capitalizeFirstLetter(item.teachername)}</span>
   </div>
   <div className='d-flex flex-row justify-content-between align-items-center'>
     {item.type==="paid" &&
